const spotDefs = [
  ...
  },
  {
    ...
    image: "/random-2.jpeg",
    orientation: "Leste / Sudeste",
    tip: "Garopaba funciona bem com swell de leste/sudeste e vento mais fraco, servindo de base para vários picos próximos.",
  },
  {
    id: "silveira",
    slug: "silveira",
    ...
    image: "/random-3.jpeg",
    orientation: "Leste / Sudeste",
    tip: "Silveira segura bastante tamanho com swell de sudeste e vento terral, sendo opção clássica de mar sólido.",
  },
  {
    id: "ferrugem",
    slug: "ferrugem",
    ...
    image: "/random-4.jpeg",
    orientation: "Leste",
    tip: "Ferrugem costuma oferecer ondas divertidas com swell de leste/sudeste e vento fraco ou terral.",
  },
  {
    id: "imbituba",
    slug: "imbituba",
    ...
    image: "/random-1.jpeg",
    orientation: "Leste / Sudeste",
    tip: "Imbituba (Praia da Vila) responde bem a swell de sudeste com período mais longo e vento de oeste/noroeste.",
  },
  {
    id: "praia-do-rosa",
    slug: "praia-do-rosa",
    ...
    image: "/random-3.jpeg",
    orientation: "Leste / Sudeste",
    tip: "O Rosa funciona com diferentes swells, mas costuma render com sudeste e vento mais alinhado, variando entre Rosa Sul e Rosa Norte.",
  },
];
...
const spotConfigs = {
  ...
  garopaba: {
    id: "garopaba",
    beachOrientation: 110,
    idealWave: { min: 0.6, max: 2.5, sweetMin: 0.9, sweetMax: 1.9 },
    idealSwellDir: { min: 100, max: 150 },
    idealOffshoreWindDir: { min: 250, max: 310 },
    idealWindSpeed: { max: 10 },
    idealPeriod: { min: 9, sweet: 12 },
  },
  silveira: {
    ...
    idealWave: { min: 0.8, max: 3.0, sweetMin: 1.2, sweetMax: 2.4 },
    idealSwellDir: { min: 120, max: 160 },
    idealOffshoreWindDir: { min: 260, max: 320 },
    idealWindSpeed: { max: 12 },
    idealPeriod: { min: 10, sweet: 13 },
  },
  ferrugem: {
    id: "ferrugem",
    beachOrientation: 105,
    idealWave: { min: 0.7, max: 2.4, sweetMin: 1.0, sweetMax: 1.9 },
    idealSwellDir: { min: 90, max: 150 },
    idealOffshoreWindDir: { min: 250, max: 310 },
    idealWindSpeed: { max: 10 },
    idealPeriod: { min: 9, sweet: 12 },
  },
  imbituba: {
    id: "imbituba",
    beachOrientation: 115,
    idealWave: { min: 0.8, max: 3.0, sweetMin: 1.2, sweetMax: 2.3 },
    idealSwellDir: { min: 120, max: 160 },
    idealOffshoreWindDir: { min: 260, max: 320 },
    idealWindSpeed: { max: 12 },
    idealPeriod: { min: 10, sweet: 13 },
  ...
  "praia-do-rosa": {
    id: "praia-do-rosa",
    beachOrientation: 110,
    idealWave: { min: 0.7, max: 2.8, sweetMin: 1.0, sweetMax: 2.1 },
    idealSwellDir: { min: 110, max: 150 },
    idealOffshoreWindDir: { min: 250, max: 310 },
    idealWindSpeed: { max: 11 },
    idealPeriod: { min: 9, sweet: 12 },
